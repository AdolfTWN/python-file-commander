# File columns and status badges (v0.17.17)
...
| Column | Options |
| --- | --- |
| Name | Hidden (including Windows HIDDEN), System, filename extensions, mixed file/folder sorting, long-name scrolling, OneDrive overlay |
...
Each group also has ascending/descending sorting. Name is always present. Hidden
...
badges (both remain visible). The hover tooltip identifies OneDrive explicitly.
